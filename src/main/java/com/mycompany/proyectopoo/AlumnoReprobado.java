...
public class  AlumnoReprobado extends AlumnoMatricula {  
  ...
  //Constructor
    ...
    public AlumnoReprobado(String rutPersona,double promedioFinal ,boolean situacionAcademica, boolean rendirEvaluacionFinal){
