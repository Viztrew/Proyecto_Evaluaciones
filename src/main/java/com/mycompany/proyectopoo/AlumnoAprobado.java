...
public  class AlumnoAprobado extends AlumnoMatricula {
  
  //Instancia de Clase
    private boolean beca;
    private boolean rendirEvaluacionFinal;
  //Constructor
    public AlumnoAprobado(String rutPersona,double promedioFinal, boolean beca, boolean rendirEvaluacionFinal){
