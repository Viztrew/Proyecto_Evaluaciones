...
public class  Repitente extends AlumnoMatricula {  
  ...
  //Constructor
    ...
    public Repitente(String rutPersona,double promedioFinal ,boolean situacionAcademica, boolean rendirEvaluacionFinal){
